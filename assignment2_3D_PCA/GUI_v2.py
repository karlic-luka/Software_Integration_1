...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.progress_texture = QtWidgets.QProgressBar(self.uipanel1)
        self.progress_texture.setProperty("value", 0)
        self.progress_texture.setObjectName("progress_texture")
        self.verticalLayout_5.addWidget(self.progress_texture)
        self.progress_geometry = QtWidgets.QProgressBar(self.uipanel1)
        self.progress_geometry.setProperty("value", 0)
        self.progress_geometry.setObjectName("progress_geometry")
        self.verticalLayout_5.addWidget(self.progress_geometry)
        spacerItem2 = QtWidgets.QSpacerItem(20, 5, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout_5.addItem(spacerItem2)
        self.pb_stop_processing = QtWidgets.QPushButton(self.uipanel1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pb_stop_processing.sizePolicy().hasHeightForWidth())
        self.pb_stop_processing.setSizePolicy(sizePolicy)
        self.pb_stop_processing.setMaximumSize(QtCore.QSize(16777215, 50))
        self.pb_stop_processing.setDefault(False)
        self.pb_stop_processing.setFlat(False)
        self.pb_stop_processing.setObjectName("pb_stop_processing")
        self.verticalLayout_5.addWidget(self.pb_stop_processing)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pb_stop_processing.setText(_translate("MainWindow", "Stop Processing"))
